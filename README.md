...
每天北京时间 09:00 触发工作流，在运行准备完成后至当天 12:00 之间随机等待，再执行一次签到。手动触发和 push 触发不随机等待。

GitHub Actions 调度可能延迟；若准备完成时已超过 12:00，则立即签到。随机等待期间会占用 Actions runner 运行时间，最长约 3 小时。
